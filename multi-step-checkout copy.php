...
function msc_enqueue_scripts() {
    ...
    // Bootstrap (needs jQuery, okay for general layout)
    ...
    // Main plugin script (no jQuery UI dependency anymore)
    wp_enqueue_script('msc-script', plugin_dir_url(__FILE__) . 'assets/script.js', [], null, true);
    ...
    wp_enqueue_script('msc-checkout', plugin_dir_url(__FILE__) . 'assets/checkout.js', ['google-maps-places-api'], null, true);
